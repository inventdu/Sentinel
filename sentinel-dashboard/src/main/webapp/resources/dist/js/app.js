...
angular.module("sentinelDashboardApp", ["oc.lazyLoad", "ui.router", "ui.bootstrap", "angular-loading-bar", "ngDialog", "ui.bootstrap.datetimepicker", "ui-notification", "rzTable", "angular-clipboard", "selectize", "angularUtils.directives.dirPagination"]).factory("AuthInterceptor", ["$window", "$state",
                ...
                resolve: {
                    loadMyFiles: ["$ocLazyLoad",
                        function(e) {
                            return e.load({
                                name: "sentinelDashboardApp",
                                files: ["app/scripts/controllers/degrade_v2.js"]
                            })
                        }]
                }
                ...
                resolve: {
                    loadMyFiles: ["$ocLazyLoad",
                        function(e) {
                            return e.load({
                                name: "sentinelDashboardApp",
                                files: ["app/scripts/controllers/system_v2.js"]
                            })
                        }]
                }
    ...
    (app = angular.module("sentinelDashboardApp")).service("DegradeServiceV2", ["$http",
        function(a) {
    ...
    (app = angular.module("sentinelDashboardApp")).service("SystemServiceV2", ["$http",
        function(a) {
            this.queryMachineRules = function(e, r, t) {
                return a({
                    url: "/v2/system/rules",
                ...
                this.newRule = function(e) {
                    ...
                    return 0 == e.grade ? r.highestSystemLoad = e.highestSystemLoad: 1 == e.grade ? r.avgRt = e.avgRt: 2 == e.grade ? r.maxThread = e.maxThread: 3 == e.grade ? t.qps = e.qps: 4 == e.grade && (t.highestCpuUsage = e.highestCpuUsage),
                        a({
                            url: "/v2/system/rule",
                            data: r,
                            method: "POST"
